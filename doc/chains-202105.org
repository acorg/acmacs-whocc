# Time-stamp: <2021-06-08 17:52:07 eu>
...
make -C ${ACMACSD_ROOT}/sources/acmacs-whocc/web/chains-202105 CHAINS_ROOT=<.../chains-202105>

gunicorn -c <.../chains-202105/gunicorn/gunicorn.conf.py> application:app
